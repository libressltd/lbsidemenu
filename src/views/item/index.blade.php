							...
							<table class="table table-bordered table-hover">
				                ...
				                <tbody>
					                ...
					                <tr>
					                	...
					                	<td>{!! Form::lbSelect2("parent_id", null, App\Models\LBSM_item::toOption()) !!}</td>
	                					<td>{!! Form::lbSelect2multi("roles[]", null, App\Models\Role::toOption()) !!}</td>
	                					<td>{!! Form::lbSelect2multi("permissions[]", null, App\Models\Permission::toOption()) !!}</td>
					                	<td>{!! Form::lbSubmit() !!}</td>
					                </tr>
					                {!! Form::close() !!}
				                </tbody>
